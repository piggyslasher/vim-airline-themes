...
" Color palette
let s:gui_dark_gray = '#1a1a1a'
let s:cterm_dark_gray = 234
let s:gui_med_gray_hi = '#2a2a2a'
let s:cterm_med_gray_hi = 236
let s:gui_med_gray_lo = '#3a3a3a'
let s:cterm_med_gray_lo = 237
let s:gui_light_gray = '#555555'
let s:cterm_light_gray = 239
let s:gui_lightlight_gray = '#ecf0f1'
let s:cterm_lightlight_gray = 245
let s:gui_green = '#2ecc71'
let s:cterm_green = 151
let s:gui_blue = '#3498db'
let s:cterm_blue = 67
let s:gui_purple = '#6c71c4'
let s:cterm_purple = 139
let s:gui_orange = '#0d7e22'
let s:cterm_orange = 173
let s:gui_red = '#e74c3c'
let s:cterm_red = 131
let s:gui_pink = '#f1c40f'
